    ...
    <div className={`relative ${className}`}>
      ...
      >
        ...
        <span 
          ...
          style={{
            background: 'conic-gradient(from 90deg at 50% 50%, rgba(255,255,255,0.4) 0deg, rgba(255,255,255,0.4) 15deg, transparent 16deg, transparent 344deg, rgba(255,255,255,0.4) 345deg)',
            animationDelay: '0s'
          }}
        />
        ...
        <motion.button
          onClick={onClick}
          whileTap={{ scale: 0.95 }}
          className="relative text-white rounded-full shadow-lg w-16 h-16 sm:w-20 sm:h-20 flex items-center justify-center font-medium text-sm sm:text-base transition-all duration-300 cursor-pointer"
          style={{
